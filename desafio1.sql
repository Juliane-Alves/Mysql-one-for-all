...
CREATE TABLE IF NOT EXISTS SpotifyClone.userr (
  id_user INT PRIMARY KEY auto_increment,
  name_user VARCHAR(50) NOT NULL,
  age INT NOT NULL,
  plan_id INT NOT NULL,
  FOREIGN KEY (plan_id) REFERENCES plan (plan_id),
  signature_date VARCHAR(25) NOT NULL
) ENGINE = InnoDB;
...
VALUES
  ...
  (5, 'Tyler Isle'),
  (6, 'Fog');
INSERT INTO SpotifyClone.plan (plan_id, plan, value_plan)
VALUES
  (1, 'gratuito', 0),
  (2, 'universitário', 5.99),
  (3, 'pessoal', 6.99),
  (4, 'familiar', 7.99);
INSERT INTO SpotifyClone.album (album_id, name_album, artist_id, year_release)
VALUES
  (1, 'Envious', 1, 1990),
  (2, 'Exuberant', 1, 1993),
  ...
  (10, 'Apparatus', 6, 2015); 
INSERT INTO SpotifyClone.music (music_id, music, duration_seconds, album_id)
VALUES
  (1, 'Soul For Us', 200, 1),
...
INSERT INTO SpotifyClone.userr (id_user, name_user, age, plan_id, signature_date)
VALUES
...
INSERT INTO SpotifyClone.historic (id_user, music_id, play_date)
VALUES
...
INSERT INTO SpotifyClone.following (id_user, artist_id)
VALUES
  (1, 1),
  (1, 3),
  (1, 4),
